...
class KnapsackSolution(BaseModel):
    instance_uid: str = Field(..., description="The unique identifier of the instance")
    objective: NonNegativeFloat = Field(..., description="The objective value of the solution")
...
# The fields that can be used to use with keyword search
SEARCH_FIELDS = ["instance_uid"]
