...
def load_problem(app: FastAPI, path: Path):
    ...
    solution_repository = SolutionRepository(problem_info) if problem_info.solution_model else None
    solution_index = SolutionIndex(problem_info) if problem_info.solution_model else None
